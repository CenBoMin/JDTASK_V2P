...
git clone https://ghproxy.com/https://github.com/Aaron-lv/sync/tree/jd_scripts
...
git config pull.rebase false && git fetch https://ghproxy.com/https://github.com/Aaron-lv/sync/tree/jd_scripts && git pull origin main
